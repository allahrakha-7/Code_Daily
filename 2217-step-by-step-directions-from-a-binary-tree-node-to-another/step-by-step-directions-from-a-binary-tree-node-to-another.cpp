...
public:
    string getDirections(TreeNode* root, int startValue, int destValue) {
        TreeNode* Lowest_Common_Ancestor = findLCA(root, startValue, destValue);
        string pathToStart = "";
        string pathToDest = "";

        findPath(Lowest_Common_Ancestor, startValue, pathToStart);
        findPath(Lowest_Common_Ancestor, destValue, pathToDest);
